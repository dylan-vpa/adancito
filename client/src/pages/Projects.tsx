...
export function Projects() {
    ...
    return (
        <div className="flex" style={{ height: '100vh', backgroundColor: 'var(--color-primary-main)' }}>
            <Sidebar />
                    ...
                    <div className="flex items-center justify-between" style={{ marginBottom: 'var(--spacing-2xl)' }}>
                        <div>
                            ...
                            <p className="text-secondary" style={{ marginTop: 'var(--spacing-sm)' }}>
                                Organiza tus ideas de negocio por proyecto
                            </p>
                        </div>
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center" style={{ marginTop: 'var(--spacing-2xl)' }}>
                            <div style={{
                                ...
                                <FolderKanban size={48} color="var(--color-accent-green-main)" />
                            </div>
                            <h2 className="text-secondary">No tienes proyectos aún</h2>
                            <p className="text-muted" style={{ marginTop: 'var(--spacing-md)', marginBottom: 'var(--spacing-lg)' }}>
                        ...
                        <div style={{
                            ...
                            {projects.map((project) => (
                                ...
                                >
                                    ...
                                    {project.description && (
                                        <p className="text-secondary caption text-ellipsis" style={{ marginBottom: 'var(--spacing-md)' }}>
                                            {project.description}
                                        </p>
                                    )}
